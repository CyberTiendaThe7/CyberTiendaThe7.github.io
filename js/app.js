...
function leerDatosCafe(cafe) {
    ...
    row.innerHTML = '<td> <img src="${cafe.imagen}" width=100 </tb>  <td>${cafe.titulo} </td> <td>${cafe.precio} </td>  <a href="#" class="borrar-cafe" data-id="${cafe.id}">X</a> </td> </td>';
...
function leerLocalStorage() {
    ...
    cafesLS.ForEach(function(cafe){
        ...
        <td>${cafe.precio}</td>
        <td>
        <a href="#" class"borrar-cafe" data-id="${cfae.id}"><a/>
        </td>
        `;
